...
public class GroceryController {
	...
	/**
	 * Get a list of vegetable/fruit sorted by name, their maximum price ,date on which price was max.
	 * @return
	 * @throws ItemNameNotFoundException
	 * @throws GroceryPriceDataBusinessException
	 */
	 @GetMapping("/getGroceryItemByMaxPrice")
	  public ResponseEntity<List<GroceryPriceDataResponse>> getGroceryItemByMaxPriceAndSorted() throws GroceryPriceDataBusinessException {
		...
		try {
			...
			logger.error("GroceryPriceDataBusinessException :" + e.getMessage() + " occured in getGroceryItemByMaxPriceAndSorted",this.getClass());
	 ...
	 @GetMapping("/getAllGroceryItemsSortByName")
	    public ResponseEntity<List<GroceryPriceDataResponse>> getAllGroceryItemsSortByName(@NotBlank @RequestParam(name="itemName",required = true)  String itemName) throws GroceryPriceDataBusinessException {
	    	List<GroceryPriceDataResponse> groceryPriceDataResponseList;
			try {
	 ...
	 @GetMapping("/getAllGroceryItemsByNameContains")
	    public ResponseEntity<List<GroceryPriceDataResponse>> getAllGroceryItemsByNameContains(@NotBlank @RequestParam(name="itemName",required = true) @Valid String itemName) throws GroceryPriceDataBusinessException {
	    	List<GroceryPriceDataResponse> groceryPriceDataResponseList;
			try {
				...
				logger.error("GroceryPriceDataBusinessException :" + e.getMessage() + " occured in getAllGroceryItemsByNameContains",this.getClass());
				 throw new GroceryPriceDataBusinessException(CommonConstants.SERVICE_EXCEPTION_MSG);
			}
	    	return new ResponseEntity<List<GroceryPriceDataResponse>>(groceryPriceDataResponseList, HttpStatus.OK);
	    }  
